...
global THRESHOLD_PATH DIS_PERIOD
...
DIS_PERIOD                  = 100; % define the display period for echoing the the screen
METHOD                      = 'HDPVARHMM(1)'; %sHDPHMM, HDPVARHMM(1),HDPVARHMM(2)
ROBOT                       = 'HIRO';
TASK                        = 'SA';
STATE                       = {'APPROACH', 'ROTATION', 'INSERTION', 'MATING'};
SIGNAL_TYPE                 = {'R_Torques','R_Angles'}; %'R_CartPos'  %'R_CartPos_Corrected' %'R_Torques'  %'R_Angles'
