...
% \pi_j \sim DP(\alpha+\kappa,(\alpha\beta+\kappa\delta(j))/(\alpha+\kappa)) (In paper: P11~4.1)
...
% \rho = \kappa/(\kappa + \alpha)
c=hyperhyperparams.c; %\kappa
d=hyperhyperparams.d; %\alpha
...
if resample_kappa
    rho0 = c/(c+d); %self-transition parameter
else
    rho0 = 0; % betarnd(0,1);
end
